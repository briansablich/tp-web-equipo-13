...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="carouselExample" class="carousel slide">
        ...
        <div class="carousel-inner">
            <asp:Repeater ID="repCarouselImagenes" runat="server">
                <ItemTemplate>
                    ...
                    <div class="carousel-item active" style="width:500px; height:500px; overflow:hidden; object-position:center; text-align: center; justify-content: center; align-items: center;" >
        ...
        <button class="carousel-control-next" type="button" data-bs-target="#carouselExample" data-bs-slide="next">
            <span class="carousel-control-next-icon" style="background-color: grey; border-radius:40%; position: absolute;
    top: 50%;
    transform: translateY(-50%); right:7%" aria-hidden="true"></span>
